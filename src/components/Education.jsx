            ...
            {EDUCATION.map((education, index)=>(
                <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                    ...
                    <motion.div 
                        ...
                        {/* CGPA Section Added Here */}
                        <span className="mr-2 mt-4 rounded bg-purple-900 px-3 py-1 text-sm font-bold text-white inline-block">
                            {education.cgpa}
                        </span>
                        
                        <p className="my-4 text-neutral-400">{education.description}</p>
